...
- Raw Data and 1-second Dataset: These must be downloaded from the original source.
- 10-second Dataset: This can be generated by running the accompanying files edf_to_numpy.ipynb` and `EdfToNumpy2.ipynb` . Both Jupyter notebooks process raw data and output the corresponding data and label files.
